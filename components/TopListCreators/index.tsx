    ...
    return (
        ...
        <section className="container" >
            ...
            <div className="flex justify-center items-center">
                <div className="w-[50%] border border-icons rounded-full px-12 py-5 flex justify-between lg:flex-row flex-col mt-12">
                <button className="ButtonQHarr text-xl flex justify-between items-center rounded-full shadow-icons border-icons px-8 py-4 border   hover:bg-shadowLight bg-icons text-shadowLight hover:text-icons ">
