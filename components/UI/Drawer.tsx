...
import { Discovermenu , HelpCenterMenu } from "./Navbar";
...
function Drawer(props: type) {
  ...
  const [item] = useState(Discovermenu);
    ...
    <>
      ...
      {props.flag == "Main" ? (
        <div className="relative">
          {!showModal ? (
            <button
              className="close lg:hidden inliblock"
              type="button"
              onClick={() => setShowModal(true)}
            >
              <svg
                className="h-8 w-8 text-icons"
                viewBox="0 0 24 24"
                fill="none"
                stroke="currentColor"
                stroke-width="2"
          ...
          {showModal ? (
            <button
              className="close lg:hidden inliblock z-50 "
              type="button"
      ...
      setHelpOpen(false)
              ...
              <div className="bg-icons w-full h-[1px] my-12"></div>
              <div id="buttons" className="flex justify-between md:w-[60%] w-[80%] px-4">
                <Button title="connect" type="yellow" />
                <Button title="Connect Wallet" type="yellow" />
