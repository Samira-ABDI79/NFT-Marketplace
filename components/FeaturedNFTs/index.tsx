   ...
   {CartList.map(({price,count,time,likeCount,images,image,category}, index) => (
       <div>
           {type==category ? 
               ...
               <div id="likeCount" className="absolute lg:-mt-[14rem] -mt-[14rem] lg:ml-44 ml-[65%] md:ml-[78%] md:-mt-[18rem] flex text-[18px] bg-icons text-shadowDark  w-16 rounded-full items-center justify-center py-1">
